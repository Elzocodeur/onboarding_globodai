...
// in onboarding/test/viewmodels/tasks_viewmodel_test.dart.
...
import 'package:onboarding/domain/entities/task.dart' as _i4;
import 'package:onboarding/domain/repositories/task_repository.dart' as _i2;
...
class MockTaskRepository extends _i1.Mock implements _i2.TaskRepository {
  ...
  @override
  _i3.Future<bool> taskExists(String? taskId) => (super.noSuchMethod(
        Invocation.method(
          #taskExists,
          [taskId],
        ),
